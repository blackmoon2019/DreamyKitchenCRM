    ...
    Private Sub frmVersions_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Select Case Mode
            ...
            Case FormMode.EditRecord
                ...
                LoadForms.LoadForm(LayoutControl1, "Select * from vw_DMVER where id = " & toSQLValueS(sID))
        End Select
        Me.CenterToScreen()
    ...
    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        Try
            If Valid.ValidateForm(LayoutControl1) Then
                Select Case Mode
                    Case FormMode.NewRecord
                        sResult = DBQ.InsertNewData(DBQueries.InsertMode.OneLayoutControl, "DM_VER", LayoutControl1)
                    Case FormMode.EditRecord
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ...
        Try
            ...
            sSQL = "insert into [dbo].[VER_HIST] (ID, ExeVer, DbVer, FilesToBeUpdated, DateUpdated) " &
                "Select  newid()," & toSQLValueS(myValue) & "," & toSQLValueS(myValue) & ",'DreamyKitchenCRM.exe',getdate()"
            'Εκτέλεση QUERY
            Using oCmd As New SqlCommand(sSQL.ToString, CNDB)
                oCmd.ExecuteNonQuery()
            End Using
