            ...
            If Valid.ValidateForm(LayoutControl1) Then
                Select Case Mode
                    Case FormMode.NewRecord
                        ...
                        sResult = DBQ.InsertNewData(DBQueries.InsertMode.OneLayoutControl, "TECH_SUP", LayoutControl1,,, sGuid,, IIf(FromProgrammer = False, "fromUserID,createdBy", ""), IIf(FromProgrammer = False, toSQLValueS(UserProps.ID.ToString) & "," & toSQLValueS(UserProps.ID.ToString), ""))
                    Case FormMode.EditRecord
                        sResult = DBQ.UpdateNewData(DBQueries.InsertMode.OneLayoutControl, "TECH_SUP", LayoutControl1,,, sID,,,,, IIf(FromProgrammer = False, "fromUserID =  " & toSQLValueS(UserProps.ID.ToString) & ",createdBy = " & toSQLValueS(UserProps.ID.ToString), ""))
                End Select
                If sResult Then
                    SaveTech = True
                    'Εκτέλεση QUERY
