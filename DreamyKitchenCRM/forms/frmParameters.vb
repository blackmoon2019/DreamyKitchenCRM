...
Public Class frmParameters
    ...
    Private Sub SimpleButton5_Click(sender As Object, e As EventArgs) Handles SimpleButton5.Click
        Prog_Prop.SetProgInstEmail(ELLIPSE_BODY_INF.EditValue.ToString, INSTALLATIONS_EMAIL.EditValue.ToString, ELLIPSE_SUBJECT_INF.EditValue.ToString, INSTALLATIONS_EMAIL_SUP.EditValue.ToString, ELLIPSE_SUBJECT_SUP_INF.EditValue.ToString, ELLIPSE_BODY_SUP_INF.EditValue.ToString, ELLIPSE_BODY_INF_APPOINTMENT.EditValue.ToString)
