            ...
            If Valid.ValidateForm(LayoutControl1) Then
                Select Case Mode
                    Case FormMode.NewRecord
                        ...
                        sResult = DBQ.InsertNewData(DBQueries.InsertMode.OneLayoutControl, "SALER_CALENDAR", LayoutControl1,,, sGuid,, "salersID", toSQLValueS(System.Guid.Parse(UserProps.SalerID.ToString).ToString))
                    Case FormMode.EditRecord
