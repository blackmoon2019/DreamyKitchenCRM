...
Public Class frmCalendarPersonal
    ...
    Private Sub frmCalendarPersonal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Dim sSQL As String
            sSQL = "SELECT * FROM vw_SALER_CALENDAR WHERE empID = " & toSQLValueS(UserProps.EmpID.ToString) & " order by code"
    ...
    Public Sub SetCalendarFilter(Optional ByVal sWhere As String = "")
        ...
        sSQL = "SELECT * FROM vw_SALER_CALENDAR WHERE empID = " & toSQLValueS(UserProps.EmpID.ToString)
