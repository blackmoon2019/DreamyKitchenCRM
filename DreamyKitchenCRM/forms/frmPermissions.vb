...
Public Class frmPermissions
    ...
    Private Sub frmPermissions_Load(sender As Object, e As EventArgs) Handles Me.Load
        'TODO: This line of code loads data into the 'DMDataSet.FORMRIGHTS' table. You can move, or remove it, as needed.
        Me.FORMRIGHTSTableAdapter.Fill(Me.DMDataSet.FORMRIGHTS)
        Try
