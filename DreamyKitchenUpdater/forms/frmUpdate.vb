...
Partial Public Class frmUpdate
    ...
    Private Sub cmdUpdate_Click(sender As Object, e As EventArgs) Handles cmdUpdate.Click
        ...
        Try
            ...
            End While
            If (XtraMessageBox.Show("Η ενημέρωση ολοκληρώθηκε με επιτυχία.Θέλετε να ανοίξω το Dreamy Kitchen CRM?", "Dreamy Kitchen CRM", MessageBoxButtons.YesNo, MessageBoxIcon.Information)) = DialogResult.Yes Then
                Shell(strArg(2) & "\DreamyKitchenCRM.exe")
                End
            End If
            sdr.Close()
